...
use partials\NotificationPartial;
    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center justify-start">
        ...
        <a href="/" class="flex ml-2 md:mr-24">
          <img src="/images/logo.png" class="h-8 mr-3" alt="Avaris Logo" />
        </a>
      </div>
      <div class="flex items-center">
          ...
          <div class="z-20 z-50 hidden max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:divide-gray-600 dark:bg-gray-700" id="notification-dropdown">
            ...
            <div>
              <?php 
                echo NotificationPartial::render_message(array(
                  "user"    => array("name" => "Micheal Alaniz"),
                  "subject" => "What the actual sigma bro?",
                  "timestamp" => date("Y-m-d H:i:s")
                ));

                echo NotificationPartial::render_follower(array(
                  "user" => array("name" => "Anthony Carmona"),
                  "timestamp" => date("Y-m-d H:i:s")
                ));

                echo NotificationPartial::render_like(array(
                  "user" => array("name" => "Erik Luna"),
                  "timestamp" => date("Y-m-d H:i:s")
                ));

                echo NotificationPartial::render_mention(array(
                  "user" => array("name" => "Carlos Rojas"),
                  "subject" => "I get geeked up for Marvel Rivals!!",
                  "timestamp" => date("Y-m-d H:i:s")
                ));
          ...
          <div class="z-20 z-50 hidden max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:bg-gray-700 dark:divide-gray-600" id="apps-dropdown">
            ...
            <div class="grid grid-cols-3 gap-4 p-4">
              ...
              <a href="/dashboard/settings" class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600">
            ...
            <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown-2">
              <div class="px-4 py-3" role="none">
                <p class="text-sm text-gray-900 dark:text-white" role="none">
                  <?php echo $session->get_user_name(); ?>
                </p>
                <p class="text-sm font-medium text-gray-900 truncate dark:text-gray-300" role="none">
                  <?php echo $session->get_user_email() ?>
                </p>
              </div>
