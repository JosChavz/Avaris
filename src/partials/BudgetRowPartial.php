...
class BudgetRowPartial {
  ...
  <tr>
      ...
      <td class="p-4 text-sm font-semibold text-gray-900 whitespace-nowrap dark:text-white">
        <?php echo date($budget->from_date) ?>
      </td>
      <td class="p-4 text-sm font-semibold text-gray-900 whitespace-nowrap dark:text-white">
        <?php echo date($budget->to_date) ?>
      </td>
      <td class="p-4 whitespace-nowrap justify-end">
        <button id="budget_<?php echo $budget->id ?>-dropdown-button" data-dropdown-toggle="bank_<?php echo $bank->id; ?>-dropdown" class="inline-flex items-center p-0.5 text-sm font-medium text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100" type="button">
          ...
          class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" 
              aria-labelledby="budget_<?php echo $budget->id; ?>-dropdown-button">
                ...
                <li>
                  <a href="/dashboard/budgets/edit/<?php echo $budget->id; ?>" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Edit</a>
                </li>
            </ul>
            <div class="py-1">
