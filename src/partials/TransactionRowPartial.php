  ...
  ?>
    <tr>
      ...
      <td class="p-4 whitespace-nowrap justify-end">
        ...
        <div id="transaction_<?php echo $transaction->id; ?>-dropdown" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="transaction<?php echo $transaction->id; ?>-dropdown-button">
                <li>
                  <a href="/dashboard/transactions/view/<?php echo $transaction->id; ?>" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">View</a>
                </li>
                <li>
                  <a href="/dashboard/transactions/edit/<?php echo $transaction->id; ?>" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Edit</a>
                </li>
            </ul>
            <div class="py-1">
              <a href="/dashboard/transactions/delete/<?php echo $transaction->id; ?>" class="block py-2 px-4 text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Delete</a>
            </div>
        </div>
      </td>
    </tr>
